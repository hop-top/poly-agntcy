...
*/
        pub async fn get_workload(
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/agntcy.dir.runtime.v1.DiscoveryService/GetWorkload",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "agntcy.dir.runtime.v1.DiscoveryService",
                        "GetWorkload",
                    ),
                );
...
*/
        pub async fn list_workloads(
            ...
            tonic::Response<tonic::codec::Streaming<super::Workload>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/agntcy.dir.runtime.v1.DiscoveryService/ListWorkloads",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
*/
        ...
        type ListWorkloadsStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::Workload, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        /** List all workloads based on filters.
...
*/
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/agntcy.dir.runtime.v1.DiscoveryService/GetWorkload" => {
                    ...
                    struct GetWorkloadSvc<T: DiscoveryService>(pub Arc<T>);
                    impl<
                        T: DiscoveryService,
                    ...
                    for GetWorkloadSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as DiscoveryService>::get_workload(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/agntcy.dir.runtime.v1.DiscoveryService/ListWorkloads" => {
                    #[allow(non_camel_case_types)]
                    struct ListWorkloadsSvc<T: DiscoveryService>(pub Arc<T>);
                    impl<
                        T: DiscoveryService,
                    ...
                    for ListWorkloadsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DiscoveryService>::list_workloads(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "agntcy.dir.runtime.v1.DiscoveryService";
