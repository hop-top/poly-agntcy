...
pub mod event_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("agntcy.dir.events.v1.EventService", "Listen"));
...
pub mod event_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/agntcy.dir.events.v1.EventService/Listen" => {
                    ...
                    struct ListenSvc<T: EventService>(pub Arc<T>);
                    impl<
                        T: EventService,
                    ...
                    for ListenSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as EventService>::listen(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "agntcy.dir.events.v1.EventService";
