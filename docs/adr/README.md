...
| [ADR-0006](0006-naming-source-vanity-mirrors.md) | Naming — `poly-agntcy` source, `hop.top/agntcy` Go vanity, per-language mirror | Partially superseded by ADR-0008 and ADR-0010 | 2026-05-30 |
...
| [ADR-0009](0009-mirror-publish-topology.md) | Mirror publish topology — defer multi-component-per-mirror fix | Superseded by ADR-0010 | 2026-06-08 |
| [ADR-0010](0010-one-mirror-per-package.md) | One mirror per package — `agntcy-<lang>-<rest>` naming | Accepted | 2026-06-08 |
