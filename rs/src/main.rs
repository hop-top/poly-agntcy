...
#[derive(Parser)]
#[command(name = "poly-agntcy", version, about = "Polyglot SDK suite for the AGNTCY Agent Directory Service (DIR)")]
struct Cli {
    #[command(subcommand)]
    cmd: SubCmd,
}
